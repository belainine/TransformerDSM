...
def main():
    ...
    parser.add_argument('-model', required=False,
                        help='Path to model weight file',default='model.chkpt')
    parser.add_argument('-data_pkl', required=False,
                        help='Pickle file with both instances and vocabulary.',default='data/m30k_deen_shr.pkl')
    ...
    print('m30k_deen_shr.pkl',data['vocab'])
    SRC, TRG = data['vocab']
    print(data['vocab'], data['vocab'])
